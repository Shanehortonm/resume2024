...
export const Banner = () => {
  return (
    <div
      id="Home"
      className=" banner h-full m-auto max-w-[1800px] lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center"
    >
